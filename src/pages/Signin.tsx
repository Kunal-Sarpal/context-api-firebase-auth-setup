...
function Signin() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-400 via-green-500 to-yellow-500">
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full space-y-6 animate-fadeIn">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        placeholder='Email'
                        className="w-full p-3 mt-1 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
                    />
                </div>
                <div>
                ...
                <button onClick={handleSubmit} className="w-full py-3 mt-6 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all duration-300 transform hover:scale-105">
                    Sign In
                </button>
                ...
                <button onClick={handGoogleSignin} className="flex items-center justify-center w-full py-3 mt-4 text-gray-700 border rounded-md hover:bg-gray-100 transition-all duration-300">
